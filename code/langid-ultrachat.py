...
def process_ultrachat(output_file):
    ...
    for split in splits:
        for example in tqdm(dataset[split]):
            ...
            for i, message in enumerate(messages):
                ...
                output["prompt_id"].append(example["prompt_id"])
...
def main():
    args = parse_args()
    process_ultrachat(args.output_file)

if __name__ == "__main__":
    main()

# Example usage:
# python code/langid-ultrachat.py --output_file=./outputs/ultrachat-langid/langid.csv