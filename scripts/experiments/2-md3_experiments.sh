...
# Test the script on cpu (this can take around 4 hours, you may just want to kill after a few test iterations)
# microsoft/Phi-3-mini-4k-instruct
# model="microsoft/Phi-3-mini-4k-instruct"
# model_name="Phi-3-mini-4k-instruct_8bit"
# python md3game.py --model_id $model --output_file ../outputs/md3-game/$model_name-no-answers.csv --load_8bit --seed 221 --md3_input_dir ../data/md3/ --prompt_mode "no_answers"
